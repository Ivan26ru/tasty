...
// сумма двух строк равняется 100
    function maxValue(input1, input2) {
        // первая от второй
        $(input1).change(function() { //отслеживания изменений
            ...
            if (dpg > 100) { //если больше 100
                ...
                $(input1).val(valueTrue); //присваивание предыдущего - валидного значения (текущему полю)
                $(input2).val(100 - valueTrue); //присваивание предыдущего - валидного значения (зависещему полю)
            } else if (dpg >= 0) { //если больше нуля
                $(input2).val(100 - dpg); //присваиваем значение зависещему полю
                valueTrue = dpg; //обновляем валидное значение
            } //конец условия
        ...
        // вторая от первой
            ...
            if (dpg > 100) { //если больше 100
                alert('Значение не может быть больше 100%'); //сообщение об ошибке
                $(input2).val(valueTrue); //присваивание предыдущего - валидного значения (текущему полю)
                $(input1).val(100 - valueTrue); //присваивание предыдущего - валидного значения (зависещему полю)
            } else if (dpg >= 0) { //если больше нуля
