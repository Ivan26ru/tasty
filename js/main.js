...
jQuery(document).ready(function($) {
    ...
    // отслеживание изменений
     ...
     $('#dpg').change(function() {//отслеживания изменений
     dpg = $('#dpg').val();//текущее значение поля
     if (dpg>100) {//если больше 100
        alert('Значение не может быть больше 100%');//сообщение об ошибке
        $('#dpg').val(valueTrue);//присваивание предыдущего - валидного значения (текущему полю)
        $('#dvg').val(100-valueTrue);//присваивание предыдущего - валидного значения (зависещему полю)
     }else if(dpg>=0){//если больше нуля
    $('#dvg').val(100-dpg);//присваиваем значение зависещему полю
